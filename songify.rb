...
require_relative 'lib/repos/album_repo.rb'
require_relative 'lib/repos/playlist_repo.rb'
require_relative 'lib/repos/song_repo.rb'
require_relative 'lib/repos/playlist_songs_repo.rb'